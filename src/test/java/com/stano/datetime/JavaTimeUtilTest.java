...
class JavaTimeUtilTest {
  ...
  void testSqlDateToLocalDate(java.sql.Date sqlDate, int year, Month month, int dayOfMonth) {
  ...
  void testLocalDateToSqlDate(LocalDate localDate, java.sql.Date sqlDate) {
